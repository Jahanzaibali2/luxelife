        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full border-b border-outline/30 bg-transparent py-2 font-body-md focus:border-primary focus:outline-none field-glow"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary text-on-primary font-label-caps text-label-caps py-4 rounded hover:opacity-90 btn-lift disabled:opacity-50"
          >
